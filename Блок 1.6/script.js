...
showAlltech.addEventListener("click", function () {
  showAlltech.classList.remove("show");
  hideAlltech.classList.add("display-block");

  for (let i = 0; i < hiddentech.length; i++) {
    hiddentech[i].classList.remove("hidden-tech");
    hiddentech[i].classList.add("show-hidden-tech");
  }
});

hideAlltech.addEventListener("click", function () {
  showAlltech.classList.add("show");
  hideAlltech.classList.remove("display-block");

  for (let i = 0; i < hiddentech.length; i++) {
    hiddentech[i].classList.add("hidden-tech");
    hiddentech[i].classList.remove("show-hidden-tech");
  }
});
